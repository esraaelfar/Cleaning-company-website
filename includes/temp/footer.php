            ...
            <div class="col-md-12 text-center">
                ...
                <p class="copyright">
                    ...
                    document.write(new Date().getFullYear());
                        ...
                        aria-hidden="true"></i> by <a href="https://github.com/esraaelfar" target="_blank">Esraa Elfar</a>
                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                </p>
            </div>
        </div>
...
<script src="includes/assets/js/jquery-migrate-3.0.1.min.js"></script>
...
<script src="includes/assets/js/jquery.stellar.min.js"></script>
<script src="includes/assets/js/jquery.animateNumber.min.js"></script>
...
<script src="includes/assets/js/scrollax.min.js"></script>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
<script src="includes/assets/js/google-map.js"></script>
